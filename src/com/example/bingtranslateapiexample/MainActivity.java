package com.example.bingtranslateapiexample;
...
public class MainActivity extends Activity implements OnInitListener {
	...
	public String translate(String text) throws Exception {
		...
		Translate.setClientId("Transportation_ClientID"); // Change this
		Translate
				.setClientSecret("AE4VrxxGUuiK4Qhf7tdzpwBPPZeuS+RafP/CQ70IGvQ="); // change
